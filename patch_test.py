        ...
        with torch.no_grad():  # operations inside don't track history
            ...
            for i, (images, labels) in enumerate(test_loader):
                ...
                if i in numbers:
                    ...
                    for channel in range(0, len(class_names[1:])):
                        decoded_channel = unary[0][channel]
                        tb_channel = vutils.make_grid(decoded_channel, normalize=True, scale_each=True)
                        writer.add_image(f'test_classes/_{class_names[1:][channel]}', tb_channel, i)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', nargs='?', type=str, default='runs/Apr19_211835_patch_deconvnet_skip_test/patch_deconvnet_skip_model_best.pkl',
